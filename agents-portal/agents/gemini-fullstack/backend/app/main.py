...
app = FastAPI(
    title="Gemini Fullstack Agent",
    description="Agente de IA especializado em gemini fullstack",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Gemini Fullstack Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em gemini fullstack",
        "version": "1.0.0",
        "features": [
