# Assistente Reuniao Agent

Agente de IA especializado em assistente reuniao.

## Descrição

Este agente é responsável por assistente reuniao e oferece funcionalidades avançadas de processamento e análise.
