...
app = FastAPI(
    title="Analista Dados Agent",
    description="Agente de IA especializado em analista dados",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "analista-dados",
        "name": "Analista Dados",
        "description": "Agente especializado em analista dados",
        "version": "1.0.0",
        "features": [
