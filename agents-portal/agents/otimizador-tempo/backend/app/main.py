...
app = FastAPI(
    title="Otimizador Tempo Agent",
    description="Agente de IA especializado em otimizador tempo",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Otimizador Tempo Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        "id": "otimizador-tempo",
        "name": "Otimizador Tempo",
        "description": "Agente especializado em otimizador tempo",
        "version": "1.0.0",
        "features": [
