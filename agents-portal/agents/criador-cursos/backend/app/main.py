...
app = FastAPI(
    title="Criador Cursos Agent",
    description="Agente de IA especializado em criador cursos",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "criador-cursos",
        "name": "Criador Cursos",
        "description": "Agente especializado em criador cursos",
        "version": "1.0.0",
        "features": [
