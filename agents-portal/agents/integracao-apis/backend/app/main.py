...
app = FastAPI(
    title="Integracao Apis Agent",
    description="Agente de IA especializado em integracao apis",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "integracao-apis",
        "name": "Integracao Apis",
        "description": "Agente especializado em integracao apis",
        "version": "1.0.0",
        "features": [
