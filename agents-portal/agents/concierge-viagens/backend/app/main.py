"""
Concierge Viagens - Agente de IA
"""
...
app = FastAPI(
    title="Concierge Viagens Agent",
    description="Agente de IA especializado em concierge viagens",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Concierge Viagens Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "name": "Concierge Viagens",
        "description": "Agente especializado em concierge viagens",
        "version": "1.0.0",
        "features": [
