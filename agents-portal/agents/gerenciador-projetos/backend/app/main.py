"""
Gerenciador Projetos - Agente de IA
"""
...
app = FastAPI(
    title="Gerenciador Projetos Agent",
    description="Agente de IA especializado em gerenciador projetos",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Gerenciador Projetos Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em gerenciador projetos",
        "version": "1.0.0",
        "features": [
