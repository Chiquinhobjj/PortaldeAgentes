...
app = FastAPI(
    title="Assistente Geral Agent",
    description="Agente de IA especializado em assistente geral",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Assistente Geral Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em assistente geral",
        "version": "1.0.0",
        "features": [
