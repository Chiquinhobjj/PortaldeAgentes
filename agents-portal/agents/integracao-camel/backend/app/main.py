...
app = FastAPI(
    title="Integracao Camel Agent",
    description="Agente de IA especializado em integracao camel",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Integracao Camel Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        "id": "integracao-camel",
        "name": "Integracao Camel",
        "description": "Agente especializado em integracao camel",
        "version": "1.0.0",
        "features": [
