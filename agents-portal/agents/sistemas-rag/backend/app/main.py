...
app = FastAPI(
    title="Sistemas Rag Agent",
    description="Agente de IA especializado em sistemas rag",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "sistemas-rag",
        "name": "Sistemas Rag",
        "description": "Agente especializado em sistemas rag",
        "version": "1.0.0",
        "features": [
