"""
Serviços específicos do agente sistemas-rag
"""
...
class Sistemas_RagService:
    """Serviço principal do agente sistemas-rag"""
    
    def __init__(self):
        self.name = "sistemas-rag"
        self.version = "1.0.0"
