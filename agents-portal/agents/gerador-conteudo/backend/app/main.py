...
app = FastAPI(
    title="Gerador Conteudo Agent",
    description="Agente de IA especializado em gerador conteudo",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Gerador Conteudo Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em gerador conteudo",
        "version": "1.0.0",
        "features": [
