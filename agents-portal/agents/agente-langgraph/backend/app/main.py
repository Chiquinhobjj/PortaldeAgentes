...
app = FastAPI(
    title="Agente Langgraph Agent",
    description="Agente de IA especializado em agente langgraph",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Agente Langgraph Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em agente langgraph",
        "version": "1.0.0",
        "features": [
