...
app = FastAPI(
    title="Chat Multimodal Agent",
    description="Agente de IA especializado em chat multimodal",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em chat multimodal",
        "version": "1.0.0",
        "features": [
