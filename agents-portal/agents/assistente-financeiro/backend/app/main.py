"""
Assistente Financeiro - Agente de IA
"""
...
app = FastAPI(
    title="Assistente Financeiro Agent",
    description="Agente de IA especializado em assistente financeiro",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Assistente Financeiro Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em assistente financeiro",
        "version": "1.0.0",
        "features": [
