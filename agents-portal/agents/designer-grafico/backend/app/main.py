...
app = FastAPI(
    title="Designer Grafico Agent",
    description="Agente de IA especializado em designer grafico",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Designer Grafico Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em designer grafico",
        "version": "1.0.0",
        "features": [
