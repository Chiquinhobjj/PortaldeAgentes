"""
Escritor Criativo - Agente de IA
"""
...
app = FastAPI(
    title="Escritor Criativo Agent",
    description="Agente de IA especializado em escritor criativo",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Escritor Criativo Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em escritor criativo",
        "version": "1.0.0",
        "features": [
