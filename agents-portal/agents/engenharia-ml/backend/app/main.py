...
app = FastAPI(
    title="Engenharia Ml Agent",
    description="Agente de IA especializado em engenharia ml",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "engenharia-ml",
        "name": "Engenharia Ml",
        "description": "Agente especializado em engenharia ml",
        "version": "1.0.0",
        "features": [
