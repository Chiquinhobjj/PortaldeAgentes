...
app = FastAPI(
    title="Agente Cli Tools Agent",
    description="Agente de IA especializado em agente cli tools",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Agente Cli Tools Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em agente cli tools",
        "version": "1.0.0",
        "features": [
