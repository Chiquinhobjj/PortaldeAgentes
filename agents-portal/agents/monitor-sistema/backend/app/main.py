...
app = FastAPI(
    title="Monitor Sistema Agent",
    description="Agente de IA especializado em monitor sistema",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em monitor sistema",
        "version": "1.0.0",
        "features": [
