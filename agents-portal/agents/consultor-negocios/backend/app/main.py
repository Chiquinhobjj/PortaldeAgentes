"""
Consultor Negocios - Agente de IA
"""
...
app = FastAPI(
    title="Consultor Negocios Agent",
    description="Agente de IA especializado em consultor negocios",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Consultor Negocios Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "name": "Consultor Negocios",
        "description": "Agente especializado em consultor negocios",
        "version": "1.0.0",
        "features": [
