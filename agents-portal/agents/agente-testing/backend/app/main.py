...
app = FastAPI(
    title="Agente Testing Agent",
    description="Agente de IA especializado em agente testing",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "agente-testing",
        "name": "Agente Testing",
        "description": "Agente especializado em agente testing",
        "version": "1.0.0",
        "features": [
