...
app = FastAPI(
    title="Agente Marketing Agent",
    description="Agente de IA especializado em agente marketing",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Agente Marketing Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em agente marketing",
        "version": "1.0.0",
        "features": [
