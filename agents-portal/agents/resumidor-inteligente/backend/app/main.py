"""
Resumidor Inteligente - Agente de IA
"""
...
app = FastAPI(
    title="Resumidor Inteligente Agent",
    description="Agente de IA especializado em resumidor inteligente",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Resumidor Inteligente Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em resumidor inteligente",
        "version": "1.0.0",
        "features": [
