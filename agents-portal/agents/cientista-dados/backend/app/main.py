...
app = FastAPI(
    title="Cientista Dados Agent",
    description="Agente de IA especializado em cientista dados",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em cientista dados",
        "version": "1.0.0",
        "features": [
