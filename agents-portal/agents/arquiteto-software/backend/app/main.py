"""
Arquiteto Software - Agente de IA
"""
...
app = FastAPI(
    title="Arquiteto Software Agent",
    description="Agente de IA especializado em arquiteto software",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Arquiteto Software Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em arquiteto software",
        "version": "1.0.0",
        "features": [
