"""
Assistente Juridico - Agente de IA
"""
...
app = FastAPI(
    title="Assistente Juridico Agent",
    description="Agente de IA especializado em assistente juridico",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Assistente Juridico Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em assistente juridico",
        "version": "1.0.0",
        "features": [
