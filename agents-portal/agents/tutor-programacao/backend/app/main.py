"""
Tutor Programacao - Agente de IA
"""
...
app = FastAPI(
    title="Tutor Programacao Agent",
    description="Agente de IA especializado em tutor programacao",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Tutor Programacao Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "name": "Tutor Programacao",
        "description": "Agente especializado em tutor programacao",
        "version": "1.0.0",
        "features": [
