"""
Analista Financeiro - Agente de IA
"""
...
app = FastAPI(
    title="Analista Financeiro Agent",
    description="Agente de IA especializado em analista financeiro",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Analista Financeiro Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em analista financeiro",
        "version": "1.0.0",
        "features": [
