...
app = FastAPI(
    title="Agente Mcp Agent",
    description="Agente de IA especializado em agente mcp",
    version="1.0.0"
)
...
async def get_agent_info():
    ...
    return {
        "id": "agente-mcp",
        "name": "Agente Mcp",
        "description": "Agente especializado em agente mcp",
        "version": "1.0.0",
        "features": [
