"""
Agente Documentacao - Agente de IA
"""
...
app = FastAPI(
    title="Agente Documentacao Agent",
    description="Agente de IA especializado em agente documentacao",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Agente Documentacao Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em agente documentacao",
        "version": "1.0.0",
        "features": [
