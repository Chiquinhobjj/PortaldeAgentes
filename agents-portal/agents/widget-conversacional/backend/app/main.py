"""
Widget Conversacional - Agente de IA
"""
...
app = FastAPI(
    title="Widget Conversacional Agent",
    description="Agente de IA especializado em widget conversacional",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Widget Conversacional Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em widget conversacional",
        "version": "1.0.0",
        "features": [
