# Assistente Medico Agent

Agente de IA especializado em assistente medico.

## Descrição

Este agente é responsável por assistente medico e oferece funcionalidades avançadas de processamento e análise.
