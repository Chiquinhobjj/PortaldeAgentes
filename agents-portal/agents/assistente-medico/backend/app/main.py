"""
Assistente Medico - Agente de IA
"""
...
app = FastAPI(
    title="Assistente Medico Agent",
    description="Agente de IA especializado em assistente medico",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Assistente Medico Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "name": "Assistente Medico",
        "description": "Agente especializado em assistente medico",
        "version": "1.0.0",
        "features": [
