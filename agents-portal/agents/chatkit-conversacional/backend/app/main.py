"""
Chatkit Conversacional - Agente de IA
"""
...
app = FastAPI(
    title="Chatkit Conversacional Agent",
    description="Agente de IA especializado em chatkit conversacional",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Chatkit Conversacional Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em chatkit conversacional",
        "version": "1.0.0",
        "features": [
