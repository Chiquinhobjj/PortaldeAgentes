"""
Professor Personalizado - Agente de IA
"""
...
app = FastAPI(
    title="Professor Personalizado Agent",
    description="Agente de IA especializado em professor personalizado",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Professor Personalizado Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em professor personalizado",
        "version": "1.0.0",
        "features": [
