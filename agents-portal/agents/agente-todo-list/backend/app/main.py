...
app = FastAPI(
    title="Agente Todo List Agent",
    description="Agente de IA especializado em agente todo list",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "Agente Todo List Agent",
        "status": "online",
...
async def get_agent_info():
    ...
    return {
        ...
        "description": "Agente especializado em agente todo list",
        "version": "1.0.0",
        "features": [
